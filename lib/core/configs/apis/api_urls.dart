...
class ApiUrls {
  ...
  Uri apiGetMessagesFromConversation(String conversationId, {int? page, int? limit}) => Uri.parse('$baseUrl/api/message/conversation/$conversationId?page=$page&limit=$limit');
}